    ...
    <div class="modal" :class="state">
        ...
        <div class="modal-card">
            <header class="modal-card-head">
                <p class="modal-card-title title is-4">Deezer - Dernières sorties d'un artiste</p>
            </header>
...
export default {
    ...
    methods: {
        ...
        search() {
            this.axios.get(`https://cors-anywhere.herokuapp.com/https://api.deezer.com/search/artist?q=${this.searchQuery}`)
            .then((response) => {
